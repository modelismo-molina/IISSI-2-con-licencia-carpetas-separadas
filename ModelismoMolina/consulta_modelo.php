				...
				<div class="fila_modelos">
					...
					<?php if (isset($modelo) and ($modelo["IDMODELO"] == $fila["IDMODELO"])) { ?>
							<button id="grabar" name="grabar" type="submit" class="editar_fila">
								<img id ="grabar" src="images/guardar.png" class="editar_fila" alt="Guardar">
							</button>
							<button id="cancelar" name="cancelar" type="submit" class="editar_fila">
								<img id="imgEdi" src="images/editar2.png" class="editar_fila" alt="Cancelar" width="30">
							</button>
					<?php } else { ?>
							<button id="editar" name="editar" type="submit" class="editar_fila">
								<img id="imgEdi" src="images/editar2.png" class="editar_fila" alt="Editar Modelo" width="30">
							</button>
							
							<button id="borrar" name="borrar" type="submit" class="editar_fila">
								<img id="imgEdi" src="images/borrar.png" class="editar_fila" alt="Borrar Modelo" width="30">
							</button>
					<?php } ?>
