...
<body>
	...
	<form id="altaPedido" method="get" action="validacion_pedidos.php" onsubmit="return validacion()">
		...
		<fieldset><legend>Datos del modelo</legend>
			...
			<input id="escala" name="escala" type="text" title="Escala del modelo" placeholder="Escala del modelo (1:50,1:72...)"<?php echo $formulario['escala'];?>" required>
			</div>
		...
		<fieldset><legend>Por favor,descríbenos como quieres que sea el tratamiento*</legend>
			<TEXTAREA id="descripcion" rows="10" cols="100" name="descripcion" placeholder="Escriba su pedido en no más de 2000 caracteres" value= "<?php echo $formulario['descripcion'];?>" required></TEXTAREA><BR>
