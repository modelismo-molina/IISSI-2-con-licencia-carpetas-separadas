...
BEGIN
INSERT INTO Modelos(IdModelo,imagen,IdUsuario,IdModelista,descripcion,enlaceVideo,enlaceProductos,precio,nombre) 
VALUES (sec_mode.nextval,w_img,w_id_usu,w_id_mod,w_des,w_vid,w_prod,w_pre,w_nom);
COMMIT WORK;
END altaModelo;
/
...
w_nom IN Modelos.nombre%TYPE) IS
BEGIN
  UPDATE modelos SET imagen = w_img, IdUsuario = w_id_usu, IdModelista= w_id_mod, descripcion = w_des, enlaceVideo = w_vid, enlaceProductos = w_prod, precio = w_pre, nombre = w_nom
